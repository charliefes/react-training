...
export const getAllPaymentxs : () => PaymentType[] = () => { 
    return [
...
export const getAllPayments = (): Promise<PaymentType[]> => {
   const transactions = fetch("https://paymentsdemo.neueda.com/api/payment",
   {method : "GET" ,
